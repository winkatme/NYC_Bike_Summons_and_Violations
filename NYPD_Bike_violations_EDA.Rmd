...
# looks like max per year is 20.  so not all 29 are used at once.
```


## To Do: Which bike counter counted the most cyclists in 2022? 2023? during the busiest months?
...
```{r}
# not sure if this is possible to answer with the data.
