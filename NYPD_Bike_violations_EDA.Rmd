...
df <- readr::read_csv("df_bike_violations_2023-07-18.csv")
...
# takeaawy cor: 0.0785254 So no, as the number of riders increases, the number of violations does not.
```
