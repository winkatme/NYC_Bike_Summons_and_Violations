...
```{r}
# matches violation description with violation code.  makes it easier to see what violaion the code refers to.
...
df_bicycle_counters_boroughs<-df_bicycle_counters_boroughs |> 
  filter(!id==300028963 & !id==300029648 &!id==100009426 & !id==100055175 & !id==100009429 & !id==100005020 & !id==100051865 & !id==100048744 & !id==100062893 & !id==300020692 & !id==300020241 & !id==100010022)

#how many counters now?
...
# 29 distinct counter id's.  need to be reduced to 19
df_counts |> 
  distinct(id)
