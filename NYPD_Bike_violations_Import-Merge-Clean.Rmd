...
# 3 for willis ave, 
# 2 for manhattan bridge.  see if 2012 test counter continues after 2012
# 2 more for manhattan bridge.  whats the dif between bike comprehensive and display?  
# 2 for amsterdam/columbus.  should one be deleted?  the streets are a block away and run in different directions. Check to see if totals are equal.
# 2 for interference calibration.  not sure what that is.  
```
