...
mapview(df_bicycle_counters, xcol = "longitude", ycol = "latitude", crs = 4269, grid = FALSE)
...
# since the only na's are in the Bronx, replace_na was easiest
df_bicycle_counters_boroughs <- df_bicycle_counters_boroughs %>% 
  mutate(suburb = replace_na(suburb, 'Bronx'))
...
### Merge borough data with count data
```{r}
