...
```{r hist-daily-total-cyclists, echo=FALSE, fig.show="hold", message=FALSE, warning=FALSE, out.width="60%"}
ts_daily_total |>
...
1. Williamsburg side of Williamsburg bridge with 1964902
2. Queens side of Queensboro Bridge with 1818163: 
3. Manhattan side of Manhattan bridge with 1584788: 
4. Kent ave in Wburg with 1066870: 
5. Brooklyn Bridge with 1002070: 
