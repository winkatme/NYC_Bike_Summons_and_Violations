...
augment(ts_monthly_snaive_mod)

```

Takeaway:  This looks a lot better.  
...
gg_tsresiduals(ts_monthly_snaive_mod)
```

Takeaways:  Residuals look normally distributed enough and uncorrelated enough.  Sig lag at 12 months, but that's to be expected as there's yearly seasonality.  SLightly sig lag at 7 months.  Will safely ignore this. One potential issue is that the mean is not quite 0, it's 74750.9.  
