...
```{r}
ts_monthly_total |> 
  ggplot(aes(x=monthly_total_cyclists, y=monthly_total_violations))+
  geom_point()
```
...
ts_monthly_total |> 
  filter_index('2020-04' ~.) |> 
  ggplot(aes(x=monthly_total_cyclists, y=monthly_total_violations, col=as.factor(month(date))))+
  geom_point()
```
